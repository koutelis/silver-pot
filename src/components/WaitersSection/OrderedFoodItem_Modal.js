...
import { Button, Input, ModalWindow_2 } from "components/generic.js";
...
const OrderedFoodItem_Modal = (props) => {
    ...
    return <ModalWindow_2 onClose={cbCloseModal} visible={visible}>
...
export default OrderedFoodItem_Modal;
