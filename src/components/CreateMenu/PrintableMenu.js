...
import PrintableMenuList2 from "components/CreateMenu/PrintableMenuList2.js";
 ...
 * @param {Object} props - { fontSize: Number, itemList: Array, visible: Boolean }
 * @returns {JSX}
 */
const PrintableMenu = React.forwardRef((props, ref) => {
    ...
    return <div className={classList} ref={ref}>
        <div className={styles["printableInside"]} >
            ...
            <PrintableMenuList fontSize={fontSize} itemList={itemList} />
            {/* <PrintableMenuList2 fontSize={fontSize} itemList={itemList} onDragDrop={onDragDrop} /> */}
        </div>
    </div>
});
